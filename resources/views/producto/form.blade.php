    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group mb-3">
                    <label for="item" class="form-label fw-bold">{{ __('Item') }}</label>
            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    <label for="t_llave" class="form-label fw-bold">{{ __('Tipo de Llave') }}</label>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="sku" class="form-control @error('sku') is-invalid @enderror" 
                           ...
                           placeholder="Ej: SKU-12345" required>
                    @error('sku')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
