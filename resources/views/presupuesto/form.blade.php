        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="text" name="id_presupuesto" class="form-control @error('id_presupuesto') is-invalid @enderror" value="{{ old('id_presupuesto', $presupuesto?->id_presupuesto) }}" id="id_presupuesto" placeholder="Id Presupuesto">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="date" name="f_presupuesto" class="form-control @error('f_presupuesto') is-invalid @enderror" value="{{ old('f_presupuesto', $presupuesto?->f_presupuesto) }}" id="f_presupuesto">
            ...
            <div class="col-md-6">
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="date" name="validez" class="form-control @error('validez') is-invalid @enderror" value="{{ old('validez', $presupuesto?->validez) }}" id="validez">
            ...
            <div class="col-md-3">
                <div class="form-group mb-2 mb20">
                    ...
                    <div class="input-group">
                        <input type="number" name="descuento" class="form-control @error('descuento') is-invalid @enderror" value="{{ old('descuento', $presupuesto?->descuento) }}" id="descuento" placeholder="Descuento" min="0" max="100">
