                            ...
                            <select name="subcategoria" class="form-control select2" id="subcategoria" required>
                                ...
                                @foreach($categorias as $categoria)
                                    <option value="{{ $categoria->id_categoria }}"
                                        {{ (old('subcategoria', $costo?->subcategoria ?? null)) == $categoria->id_categoria ? 'selected' : '' }}>
                                        {{ $categoria->nombre }}
                                    </option>
                                @endforeach
                        ...
                        <div class="form-group mb-3 w-100">
                            ...
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="en_vanes" name="en_vanes" value="1" 
                                    {{ old('en_vanes', $costo?->en_vanes ?? false) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3" id="van-container" style="display: none;">
                        <div class="form-group mb-3">
                            ...
                            <select name="van" id="van" class="form-control @error('van') is-invalid @enderror">
                                ...
                                <option value="Van Grande-Pulga" {{ old('van', $costo?->van ?? '') == 'Van Grande-Pulga' ? 'selected' : '' }}>Van Grande-Pulga</option>
                                <option value="Van Pequeña-Pulga" {{ old('van', $costo?->van ?? '') == 'Van Pequeña-Pulga' ? 'selected' : '' }}>Van Pequeña-Pulga</option>
                            </select>
                            @error('van')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <select name="pago_metodo" class="form-control select2 @error('pago_metodo') is-invalid @enderror" id="pago_metodo">
                                ...
                                @foreach($metodos as $metodo)
                                    <option value="{{ $metodo->id }}" 
                                        {{ old('pago_metodo', isset($costo) ? $costo->pago_metodo : '') == $metodo->id ? 'selected' : '' }}>
                                        {{ $metodo->name }}
                                    </option>
                                @endforeach
                            </select>
...
$(document).ready(function() {
    // Show/hide van selector based on toggle
