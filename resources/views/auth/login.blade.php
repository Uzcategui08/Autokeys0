...
<body>
  <div class="login">
    ...
    <form method="POST" action="{{ route('login') }}" class="login__form">
      ...
      <h1 class="login__title">Welcome to Autokeys</h1>
      ...
      <div class="login__content">
        ...
        <div class="login__box">
          ...
          <div class="login__box-input">
            <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus class="login__input" placeholder="">
