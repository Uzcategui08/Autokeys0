        ...
        <div class="row">
            <div class="col-md-1">
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="text" name="id_orden"
                           class="form-control @error('id_orden') is-invalid @enderror"
                           value="{{ old('id_orden', $orden?->id_orden) }}" id="id_orden"
            ...
            <div class="col-md-2">
                <div class="form-group mb-2 mb20">
                    ...
                    <input type="date" name="f_orden"
                           class="form-control @error('fecha') is-invalid @enderror"
                           value="{{ old('f_orden', $orden?->f_orden) }}" id="f_orden"
                           placeholder="Fecha">
            ...
            <div class="col-md-3">
                <div class="form-group mb-2 mb20">
                    <label for="id_tecnico" class="form-label">{{ __('Técnico') }}</label>
                    <input type="text" name="id_tecnico"
                           class="form-control @error('id_tecnico') is-invalid @enderror"
                           value="{{ old('id_tecnico', $orden?->id_tecnico) }}" id="id_tecnico"
            ...
            <div class="col-md-3">
                <div class="form-group mb-2 mb20">
                    ...
                    <select name="estado" class="form-control @error('estado') is-invalid @enderror" id="estado">
                        ...
                        <option value="aprobado" {{ old('estado', $orden?->estado) == 'aprobado' ? 'selected' : '' }}>
                            Aprobado
                        </option>
                        <option value="rechazado" {{ old('estado', $orden?->estado) == 'rechazado' ? 'selected' : '' }}>
                            Rechazado
                        </option>
                    </select>
                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <select name="id_cliente"
                        ...
                        @foreach($clientes as $cliente)
                            <option value="{{ $cliente->id_cliente }}" {{ old('id_cliente', $orden?->id_cliente) == $cliente->id_cliente ? 'selected' : '' }}>{{ $cliente->nombre }}</option>
                        @endforeach
                    </select>
